package jo.vk.notedroid4.adapters;
...
import jo.vk.notedroid4.util.NoteSorters;
...
public class NotesAdapter extends BaseAdapter implements Filterable {
    ...
    public NotesAdapter(Activity context, List<Note> objects) {
        ...
        switch(sp.getString("pref_comperator", "By name"))
        {
            case "By name": Collections.sort(objects, NoteSorters.getAlfabeticNotes());
                break;
            case "Oldest first": Collections.sort(objects, NoteSorters.getOldestNotesFirst());
                break;
            case "Newest first": Collections.sort(objects, NoteSorters.getNewestNotesFirst());
                break;
        }
    ...
    public void notifyDataSetChanged() {
        Collections.sort(allNotes, NoteSorters.getAlfabeticNotes());
